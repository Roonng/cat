 ...
 *
 */
public interface IUserRefSubjectService {
	 ...
	 * @return 成功更新条数
	 */
	public int deleteBatchById(List<String> userRefSubjectlist) throws Exception;
	
	/**
	 * 批量删除【用户主题管理】信息
	 * @param userRefSubjectlist 用户主题管理信息对象列表
	 * @return 成功更新条数
	 */
	public int deleteBatchByObj(List<UserRefSubjectVO> userRefSubjectlist) throws Exception;
	 ...
	 * @return 用户主题管理信息对象
	 */
	public UserRefSubjectVO searchById(String userRefSubjectid) throws Exception;
     ...
     * @param userRefSubjectVO 用户主题管理信息主键
     * @return 用户主题管理信息对象列表
     */
	 ...
	 * @return 用户主题管理信息对象列表，含分页对象
	 */
	public PageInfo<UserRefSubjectVO> searchListPageByMap(Map<String,String> map,Integer pageNo,Integer pageSize);
