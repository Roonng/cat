...
public class ChineseTokens {
    ...
    public static void main(String[] args) {
        try {
            String[] args11=new String[11];
            args11[0] = "D:\\ideaworkspace\\cat\\data";
            args11[1] = "cityu";
            args11[2] = "hk";
            args11[3] = "cityu.out";
            args11[4] = "Big5_HKSCS";
            ...
            args11[9] = "0.0";
            args11[10] = "0.0";
            //e:\data\chineseWordSegBakeoff03 cityu hk cityu.out Big5_HKSCS 5 5.0 5000 256 0.0 0.0
            new ChineseTokens(args11).run();
        } catch (Throwable t) {
