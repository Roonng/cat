...
public class RegisterSmsCodeController {
    private static Logger log = LoggerFactory.getLogger(RegisterSmsCodeController.class);
    ...
    public Map<String, Object> smscode(HttpServletRequest request) {
        try {
            ...
            if (b) {
                LoginController.smsMap.put(mobile+"_register", code);
